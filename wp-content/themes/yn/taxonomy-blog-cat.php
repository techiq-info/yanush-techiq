...
$currentCat = $queried_object->term_id;
...
?>
    ...
    'hide_empty' => false,
					...
					<li <?php if($currentCat==$term->term_id){echo ' class="currentL"';};?>><a href="<?php
...
$content = str_replace(']]>', ']]>', $content);
	...
	<li class="<?php if($vdo){echo 'vdoPost';};?> archivePost <?php echo $layout;?>">
		<a href="<?php  $newLink = add_query_arg( 'איזור', $ezor ,get_permalink() );
						echo $newLink ;?>">
	<div class="imgConP">
