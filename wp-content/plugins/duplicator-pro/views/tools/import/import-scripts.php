...
$packageInvalidName                  = new DUP_PRO_UI_Messages(DUP_PRO_U::__('Invalid archive name, Only file types .zip &amp; .daf are supported! <br>Please try again!'), DUP_PRO_UI_Messages::ERROR);
$packageInvalidName->hide_on_init    = true;
$packageInvalidName->is_dismissible  = true;
$packageInvalidName->auto_hide_delay = 5000;
...
?><script>
    jQuery(document).ready(function ($) {
        const uploadFileMessageContent = <?php echo json_encode(DupProSnapLibIOU::getInclude(dirname(__FILE__).'/import-message-upload-error.php')); ?>;
