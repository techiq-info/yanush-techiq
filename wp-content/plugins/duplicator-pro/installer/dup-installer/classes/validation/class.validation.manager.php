...
require_once(DUPX_INIT.'/classes/validation/tests/class.validation.test.can.replace.php');
...
class DUPX_Validation_manager
{
    ...
    const ACTION_ON_START_SKIP   = 'skip';
    ...
    private function __construct()
    {
        ...
        $this->tests[] = new DUPX_Validation_test_can_replace(self::CAT_GENERAL);
    ...
    public static function isValidated()
    {
        ...
        if ($paramsManager->getValue(DUPX_Paramas_Manager::PARAM_VALIDATION_ACTION_ON_START) === self::ACTION_ON_START_SKIP) {
            return true;
        }
        
        return $paramsManager->getValue(DUPX_Paramas_Manager::PARAM_VALIDATION_LEVEL) >= DUPX_Validation_abstract_item::LV_HARD_WARNING;
    }
