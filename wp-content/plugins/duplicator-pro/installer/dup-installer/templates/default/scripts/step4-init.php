...
$admin_redirect = (($GLOBALS['DUPX_AC']->mu_mode > 0) && ($subsite_id == -1)) ? "{$site_url}/wp-admin/network/admin.php?page=duplicator-pro-tools&tab=d" : "{$site_url}/wp-admin/admin.php?page=duplicator-pro-tools&tab=d";
